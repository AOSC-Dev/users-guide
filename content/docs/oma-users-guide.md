...
![oma 调用 PolicyKit 获取 root 权限](/images/oma-users-guide/oma-password-prompt.png)
...
> [!NOTE]注意
> 
> 如果使用非桌面环境的终端模拟器，则需要通过 sudo 来获得 root 权限：
> ```
> sudo oma
> ```
...
![image](/images/oma-users-guide/oma-legacy-mode.png)

<p style="font-size: 0.8rem;text-align: center;">
传统模式，类似 APT 的操作逻辑；图中安装了 KDE 的视频播放器 Haruna
</p>

![image](/images/oma-users-guide/oma-tui-mode.png)
...
![image](/images/oma-users-guide/oma-search-demo.png)
...
![image](/images/oma-users-guide/Hy6LkPYuA.png)
